...
description: Review AI Visibility Audit artifacts deeply, separate sitewide blockers, repeated template patterns, core-page failures, and low-value URL noise, and stay aligned with the PromptScout Website-tab contract.
---
